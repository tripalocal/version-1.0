...
class WeiXinPay(object):
    ...
    def post_xml(self):
        ...
        response = post_xml(self.url, xml.encode('utf-8'))
...
class JsAPIOrderPay(UnifiedOrderPay):
    ...
    def _get_json_js_api_params(self, prepay_id):
        ...
        print('paySign', js_params["paySign"])
        return js_params

    def post_prepaid(self, body, out_trade_no, total_fee, spbill_create_ip, notify_url, code):
        if code:
