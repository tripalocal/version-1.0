...
MIDDLEWARE_CLASSES = (
    ...
    'Tripalocal_V1.middleware.HandleExceptionMiddleware',
...
AWS_ACCESS_KEY_ID = 'AKIAJMS4B2ZEHIUIKYUA'
AWS_SECRET_ACCESS_KEY = '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'
