...
urlpatterns = patterns('',
    ...
    url(r'^bringthekids/$','experiences.views.bring_the_kids'),
    url(r'^hopelessromance/$','experiences.views.hopeless_romance'),
    url(r'^localculture/$','experiences.views.local_culture'),
